...
function(INSTALL_DEVICE_FILES)
  ...
  if(NOT USE_ROI OR USE_ROI STREQUAL "USE_ROI-NOTFOUND")
    if(NOT USE_OVERLAY OR USE_OVERLAY STREQUAL "USE_OVERLAY-NOTFOUND")
  ...
  get_target_property(TOP_PCF_FILE ${DEVICE_TYPE} TOP_PCF)
  if(NOT (TOP_PCF_FILE STREQUAL "TOP_PCF_FILE-NOTFOUND"))
    list(APPEND INSTALL_FILES ${TOP_PCF_FILE})
  endif()
